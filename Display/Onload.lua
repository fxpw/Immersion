...
function frame:ADDON_LOADED(name)
	if name == _ then
		...
		LibStub('AceConfigRegistry-3.0-ElvUI'):RegisterOptionsTable(_, L.options)
		L.config = LibStub('AceConfigDialog-3.0-ElvUI'):AddToBlizOptions(_)

		-- Slash handler
		_G['SLASH_' .. _:upper() .. '1'] = '/' .. _:lower()
		SlashCmdList[_:upper()] = function() LibStub('AceConfigDialog-3.0-ElvUI'):Open(_) end
